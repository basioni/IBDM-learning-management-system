	...
	function lms_general_settings(){
		...
		switch($_GET['sub']){
			...
			default:
				...
				array(
			            'label' => __('Enable multicurrency support for instructor commissions(from activity table)', 'vibe-customtypes'),
			            'name' => 'wplms_commissions_migrate_to_activity',
			            'desc' => __('Shows currency wise setup in pay commissions tab(Requires commission to be migrated to activity from wp-admin -> lms -> settings -> functions -> Sync Areas )', 'vibe-customtypes'),
			            'type' => 'checkbox',
					),
