		...
		<div class="wrap wplms-wrap about-wrap">
			...
			<div class="changelog">
				<div class="wplms-feature feature-rest feature-section col two-col">
					<div class="col-1">
						...
						<a href="https://wplms.io/support/knowledge-base/3-9/" class="button"><?php _e( 'Check update log ', 'vibe' ); ?></a>
					</div>
					<div class="col-2">
			...
			<div class="changelog about-integrations">
				...
				<div class="wplms-feature feature-section col three-col">
					...
					<div>
						<h4>Demo 11 : Demo Switcher, One Click Installer & Setup Wizard</h4>
						<p style="max-height: 220px; overflow: hidden;">
							<img src="<?php echo VIBE_URL.'/setup/installer/images/demo11.jpg' ?>" alt="">
						</p>
						<a href="https://wplms.io/demos/demo11" class="button" target="_blank">Link</a>
					</div>
					<div>
						<h4>Demo 12 : Built On Elementor, with new elementor blocks</h4>
						<p style="max-height: 220px; overflow: hidden;">
							<img src="<?php echo VIBE_URL.'/setup/installer/images/demo12.jpg' ?>" alt="">
						</p>
						<a href="https://wplms.io/demos/demo12" class="button" target="_blank">Link</a>
					</div>
					<div>
						<h4>New Course Layout : Customizer - Layouts</h4>
						<p style="max-height: 220px; overflow: hidden;">
							<img src="<?php echo VIBE_URL.'/setup/data/uploads/new/course7layout.png' ?>" alt="cuorse 7 layout">
						</p>
				...
				<div class="wplms-feature feature-section col three-col">
					...
					<div>
						<h4>New Course block</h4>
						<p style="max-height: 220px; overflow: hidden;">
							<img src="<?php echo VIBE_URL.'/setup/data/uploads/new/course8block.png' ?>" alt="cuorse 8 block">
						</p>
						<!-- <a href="https://wplms.io/support/knowledge-base/guest-user/" class="button" target="_blank">Tutorial</a> -->
						
					</div>
					<div>
						<h4>New Elementor Blocks</h4>
						<p style="max-height: 220px; overflow: hidden;">
							<img src="<?php echo VIBE_URL.'/setup/data/uploads/new/elementor.png' ?>" alt="vibe blocks on elementor now">
						</p>
						<!-- <a href="https://wplms.io/support/knowledge-base/course-video/" class="button" target="_blank">Tutorial</a> -->
					</div>
					<div>
						<h4>Improved Course Stats </h4>
						<p style="max-height: 220px; overflow: hidden;">
							<img src="<?php echo VIBE_URL.'/setup/data/uploads/new/course_stats.png' ?>" alt="stats">
						</p>
