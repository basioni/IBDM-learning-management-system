...
class WPLMS_ZIP_UPLOAD_HANDLER{
	...
	function print_detail_form($tab="upload", $file_url="", $dirname=""){
		...
		<div class="package_upload_detail_form" style="display:none">
			...
			?>		
			<hr />
			<label><?php _e('Package Type','vibe-shortcodes') ?></label> : <select name="package_type"><option value="default"><?php _e('Default (xAPI or None)','vibe-shortcodes'); ?></option><option value="2004"><?php _e('SCORM 2004','vibe-shortcodes'); ?></option><option value="1.1"><?php _e('SCORM 1.1, 1.2','vibe-shortcodes'); ?></option></select>
		...
		<div style="display: grid; grid-template-columns: 1fr 1fr; grid-gap: 10px;">
			...
			<div>
				<div style="display:grid;grid-template-columns: 1fr 1fr;margin-bottom:10px">
					...
					<select name="package_type"><option value="default"><?php _e('Default (xAPI or None)','vibe-shortcodes'); ?></option><option value="2004"><?php _e('SCORM 2004','vibe-shortcodes'); ?></option><option value="1.1"><?php _e('SCORM 1.1, 1.2','vibe-shortcodes'); ?></option>
					</select>
				</div>
